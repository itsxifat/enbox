      ...
      <Portal>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 px-5 pb-5">
            ...
            >
              <PhoneOffIcon size={18} aria-hidden /> Decline
            </button>
            <button
              type="button"
              onClick={accept}
            ...
            >
              {d.video ? <VideoIcon size={18} aria-hidden /> : <PhoneIcon size={18} aria-hidden />}{' '}
              Accept
            </button>
          </div>
        </div>
      ...
      >
        <div className="flex flex-1 flex-col items-center px-6 pt-[calc(env(safe-area-inset-top)+64px)] text-center">
          <p className="flex items-center gap-1.5 text-[14px] text-white/70">
            {d.video ? <VideoIcon size={16} aria-hidden /> : <PhoneIcon size={16} aria-hidden />}
            {d.subtitle}
          </p>
        ...
        <div className="flex items-start justify-around px-10 pt-6 pb-[max(48px,calc(env(safe-area-inset-bottom)+32px))]">
          ...
          />
          <CallButton
            icon={d.video ? VideoIcon : PhoneIcon}
            label="Accept"
            caption="Accept"
            tone="success"
            size="xl"
